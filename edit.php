<?php include('./header.php'); ?>
  ...
  <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
    <dl>
      <dt>表題：</dt>
      <dd>
        <input type="text" name="title" value="<?php echo $_POST["title"] ?>" size="60" /><?php echo $_GET["title"] ?>
      </dd>
      <dt>本文：</dt>
      <dd>
        <textarea name="contents" rows="10" cols="60"><?php echo $_POST["contents"]; echo $_GET["contents"] ?></textarea>
      </dd>
      <dt>パスワード：</dt>
      <dd>
